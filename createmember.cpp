...
{
    QSqlQuery createMemberQuery("CREATE TABLE IF NOT EXISTS mitglieder (id INTEGER PRIMARY KEY, vorname TEXT, nachname TEXT, position TEXT, matrikelnummer TEXT, email_glr TEXT, email_privat TEXT, telefon TEXT, anschrift TEXT, sprache TEXT, aktiv BOOL)");
    ...
    bool activ = 1;     //neu angelgte Objekte immer aktiv
    QSqlQuery insertMemberQuery;

    insertMemberQuery.prepare("INSERT INTO mitglieder (vorname, nachname, position, matrikelnummer, email_glr, email_privat, telefon, anschrift, sprache, aktiv) VALUES (:firstName, :surname, :position, :student_number, :email_glr, :email_private, :phone, :address, :language, :activ)");
